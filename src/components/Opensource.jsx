    ...
    <>
      ...
      <div className="lg:mx-auto lg:w-8/12 mt-10 flex justify-center flex-wrap gap-6 my-10">

        {
          isLoading ?
            <div className="h-72">
              <ClipLoader size={150} color={'rgb(209 213 219)'} />
            </div> : (repos?.map(({ id, name, html_url, description, topics }) => {
              return (
                <div key={id} className="w-96 border border-gray-700 bg-gray-800 rounded-xl p-4 
