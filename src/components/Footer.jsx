    ...
    <footer className="text-center lg:text-left dark:bg-gray-900 bg-gray-100 text-gray-600 dark:text-gray-100">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
        ...
        <div className="flex justify-center">
          ...
          <a href="https://www.instagram.com/padawan_programmer/" target="_blank" rel="noreferrer" className="mr-6 text-gray-400">
          ...
          <a href="https://www.linkedin.com/in/venilson1/" target="_blank" rel="noreferrer" className="mr-6 text-gray-400">
          ...
          <a href="https://github.com/venilson1" target="_blank" rel="noreferrer" className="text-gray-400">
